...
//       // photo client side se aaygi (base64 encoded string form me) -> decode in Backend -> save photo's path in DB
...
//       return res.send(200).json({ blog: blogsDto });
//     } catch (error) {
//       return next(error);
//     }
//   },
...
//     return res.send(200).json({ blog: blogDto });
//   },
...
//     return res.send(200).json({ message: "Blog updated !" });
//   },
...
//     return res.send(200).json({message : 'blog Deleted'});
//   },
// };
